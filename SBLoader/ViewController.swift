...
class ViewController: UIViewController, HolderViewDelegate {
    ...
    func animateLabel() {
        // Remove HolderView from the view and set the view’s background color to blue.
        holderView.removeFromSuperview()
        view.backgroundColor = Colors.blue
        
        // Create a UILabel with text of ‘S’ to represent the logo, and add it to the view.
        ...
        // Apply a spring animation to the label to scale it in. Once the animation is done, call addButton() to add a button to your view, which, when pressed, repeats the animation.
